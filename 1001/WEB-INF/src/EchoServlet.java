...
public class EchoServlet extends HttpServlet {
   ...
   public void doGet(HttpServletRequest request, HttpServletResponse response)
      ...
      try {
         ...
         out.println("<body><h2>Megadta: </h2>");
         ...
         if (username == null
            ...
            out.println("<p>Neve: HIANYZIK</p>");
         } else {
            out.println("<p>Neve: " + username + "</p>");
         }
         ...
         if (password == null
            ...
            out.println("<p>Jelszo: HIANYZIK</p>");
         } else {
         ...
         // Get null if the parameter is missing from query string.
         if (gender == null) {
            out.println("<p>Gender: HIANYZIK</p>");
         ...
         if (age == null) {
            out.println("<p>Kora: HIANYZIK</p>");
         } else if (age.equals("1")) {
            out.println("<p>Kora: &lt; 1 ev</p>");
         } else if (age.equals("99")) {
            out.println("<p>Kora: 1 es 99ev kozott</p>");
         } else {
            out.println("<p>Kora: &gt; 99 ev</p>");
         }
         ...
         if (languages == null || languages.length == 0) {
            out.println("<p>Nyelv: HIANYZIK</p>");
         } else {
            out.println("<p>Nyelv: ");
         ...
         if (instruction == null
              ...
              || instruction.equals("Irja ide")) {
            out.println("<p>Instrukciok: HIANYZIK</p>");
         } else {
            out.println("<p>Instrukciok: " + instruction + "</p>");
         }
